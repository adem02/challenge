...
const ProjectsList = (props) => {
    ...
    const listingProjects = (project) => (
        <tr key={project.id}>
            ...
            <td><span className="material-icons text-primary" style={{ cursor: 'pointer' }} onClick={() => history.push(`update-project/${project.id}`)}>edit</span></td>
            <td><span className="material-icons text-danger" style={{ cursor: 'pointer' }} onClick={() => onDelete(project)}>delete</span></td>
        </tr>
    )
